jQuery(document).ready(function () {
    ...
    */
	...
	jQuery('label[for="edit-aksearch_publications-facets"]').append('<div id="selectAllsets" class="facets"><button class="akbutton">Select all</button><button class="aktoggle">Toggle</button></div>');
	jQuery('label[for="edit-aksearch_publications-facets-f"]').append('<div id="selectAllfacets" class="facets-f"><button class="akbutton">Select all</button><button class="aktoggle">Toggle</button></div>');
	...
	var checkAction = function(data){
		...
		jQuery(".aktoggle").click(function(){
			var checkboxes = jQuery('#edit-aksearch_publications-'+ jQuery(this).parent().attr('class') +' input:checkbox');
