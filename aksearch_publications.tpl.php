...
$root = drupal_get_path('module', 'aksearch_publications')."/default";
$app = drupal_get_path('module', 'aksearch_publications')."/default/app";
$assets = drupal_get_path('module', 'aksearch_publications')."/default/assets";
$config = drupal_get_path('module', 'aksearch_publications')."/default/config";
$css = drupal_get_path('module', 'aksearch_publications')."/default/css";
$finder = drupal_get_path('module', 'aksearch_publications')."/default/finder";
$lib = drupal_get_path('module', 'aksearch_publications')."/default/lib";
$searchurl = url('node/'.variable_get('aksearch_publications_spage'));
?>
<!-- search page -->
...
drupal_add_js('https://code.angularjs.org/1.2.25/angular-sanitize.js', array('type'=>'file','scope'=>'footer','weight'=>102));
...
<?php print isset($cont['und']['0']['safe_value']) ? $cont['und']['0']['safe_value'] : ''; ?>
 ...
 <div id="akListing" ng-app="akListing" ng-controller="mainController"  class="col-xs-12 col-sm-12 col-md-12" ng-cloak>		<!-- Language
